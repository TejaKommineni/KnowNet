...
\subsection{Applications:}
 ...
 As mentioned in section \ref{applications} our system can be used to build different applications that are helpful in network management. In that direction we have built a web tool to analyze these host behaviors. Our web tool takes the output generated by our system as input and renders different visualizations.
 
 \begin{itemize}
 	\item 
 \end{itemize}
 
 with an option to compare
