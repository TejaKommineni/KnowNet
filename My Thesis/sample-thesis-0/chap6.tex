...
The scenario 1 is of duration 11.63 hours with 37.6 GB of data. This dataset contains hosts exhibiting two unique behaviors namely normal traffic and scanners as labeled by the manual inspection. When we passed this data through our sytsem we found formation of two major clusters and the results are as shown in  \tabref{scenario1}. This is a confusion matrix and we can learn the following information from this matrix:

\begin{table}[t]
	\caption{Scenario 1.}%
	\centerline{\includegraphics[scale = 0.7]{scenario1.pdf}}	
	\tablabel{scenario1}
\end{table}
...
\begin{itemize}
	...
	\item Number of flows it as predicted as scanners and they  actually are flows belonging to scanners along with Number of flows it as predicted as Normal and they  actually are flows belonging to Normal hosts divided by the total predictions made by our system.
	...
	\begin{itemize}
		...
		\item Number of flows it as predicted as scanners and they are not flows belonging to scanners along with Number of flows it as predicted as Normal and they are not flows belonging to Normal hosts divided by the total predictions made by our system.
	...
	\begin{itemize}
		...
		\item Number of flows which are correctly predicted as scanners divided by total number of flows predicted as scanners, Number of flows which are correctly predicted as Normal divided by total number of flows predicted as Normal. 
...
From this we learn that our system can identify unique behaviors wiht high accuracy and precision.

\subsection{Scenario 2:}
The scenario 2 is of duration 0.38 hours with 5.8 GB of data. This dataset contains hosts exhibiting two unique behaviors namely normal traffic and chinese hosts as labeled by the manual inspection. When we passed this data through our system we found formation of two major clusters and the results are as shown in  \tabref{scenario2}. This information that we can learn from the confusion matrix is:

\begin{table}[t]
	\caption{Scenario 2.}%
	\centerline{\includegraphics[scale = 0.7]{scenario2.pdf}}	
	\tablabel{scenario2}
\end{table}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item (22456+76713)/107978 = 0.9184
	...
	\begin{itemize}
		...
		\item (22456)/28368 = 79.1\% precise in finding chinese hosts.
...
We have performed this because it is quite a common attack in our network to see chinese hosts.
...
\begin{table}[t]
	\caption{Scenario 3.}%
	\centerline{\includegraphics[scale = 0.6]{scenario3.pdf}}	
	\tablabel{scenario3}
\end{table}
