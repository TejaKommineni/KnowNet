...
\subsection{Applications:}
 ...
 \begin{itemize}
 	\item \figref{compare_days} is a screenshot of the web tool. Left nav bar provides different options to explore the output produced by our system. In \figref{compare_days} we can see a comparison of host behaviors on two different days. The second line can be read as follows, There are 1221 hosts which are exhibiting anomalous behavior on March 1st were as it drops to 199 on June 8th which acoounts to a decrease of 84\%. 
